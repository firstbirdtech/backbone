...
object Implicits {
  ...
  implicit val snsEnvelopeDecoder : Decoder[SnsEnvelope] = Decoder.forProduct2("Subject", "Message")(SnsEnvelope)
  implicit val snsEnvelopeEncode: Encoder[SnsEnvelope] = Encoder.forProduct2("Subject", "Message")(e => (e.subject, e.message))
