...
object Dependencies {
  ...
  private[this] val catsVersion                  = "2.3.1"
  private[this] val circeVersion                 = "0.13.0"
  private[this] val elasticMqVersion             = "1.1.0"
  ...
  private[this] val mockitoScalaVersion          = "1.16.15"
  private[this] val playJsonVersion              = "2.9.2"
  private[this] val scalaTestVersion             = "3.2.3"
  private[this] val scalaCollectionCompatVersion = "2.4.0"
